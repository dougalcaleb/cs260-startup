...
export default function Login() {
	return (
		<div className="bg-gray-3 fixed h-full w-full">
			<div className="bg-gray-3 h-max absolute m-auto top-0 bottom-0 w-full">
				<div className="flex flex-col items-center">
					...
					<input type="text" name="username" id="#username-input" placeholder="Username" className="mb-4"></input>
					<input type="password" name="password" id="#password-input" placeholder="Password" className="mb-4"></input>
					<Link to="/library">
			...
			<footer className="fixed w-full bottom-0 h-1/3 flex flex-col justify-around items-center">
				...
				<div id="credit" className="font-main text-gray-6 flex font-black">
					...
					<a href="https://github.com/dougalcaleb/cs260-startup" target="_blank" className="no-underline text-green-2">
