...
export default function LogoFooter({ showCredit = false }) {
	return (
		<footer className="fixed w-full bottom-0 h-1/4 flex flex-col justify-around items-center">
			...
			{showCredit && <div id="credit" className="font-main text-gray-6 flex font-black">
