...
export default function Popup({
	...
	return createPortal(
		<>
			<div className="fixed top-0 bottom-0 right-0 left-0 bg-gray-1 opacity-70 z-50 h-dvh"></div>

			<div className={`fixed bg-gray-4 rounded-lg top-0 bottom-0 right-0 left-0 m-auto shadow-lg shadow-gray-0 z-60 overflow-hidden ${bodyStyle}`}>
